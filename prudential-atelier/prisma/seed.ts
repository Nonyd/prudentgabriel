...
async function upsertSiteSettings() {
  const defaultSettings: {
    ...
    { key: "admin_notification_email", value: "hello@prudentgabriel.com", group: SettingGroup.EMAIL, label: "Operational alert email", type: SettingType.TEXT, isPublic: false, sortOrder: 13 },
    { key: "hr_alert_email", value: "", group: SettingGroup.EMAIL, label: "HR alert email", type: SettingType.TEXT, isPublic: false, sortOrder: 14 },
    ...
    { key: "prudent_points_rate_ngn", value: "1", group: SettingGroup.LOYALTY, label: "Prudent Points — naira value of one point", type: SettingType.NUMBER, isPublic: false, sortOrder: 0 },
    { key: "prudent_points_min_redemption", value: "5000", group: SettingGroup.LOYALTY, label: "Prudent Points — minimum redemption", type: SettingType.NUMBER, isPublic: false, sortOrder: 1 },
    { key: "prudent_points_expiry_months", value: "24", group: SettingGroup.LOYALTY, label: "Prudent Points — months until each award expires", type: SettingType.NUMBER, isPublic: false, sortOrder: 2 },
    { key: "loyalty_point_rate_ngn", value: "1", group: SettingGroup.LOYALTY, label: "Legacy rate key — use prudent_points_rate_ngn", type: SettingType.NUMBER, isPublic: false, sortOrder: 3 },
    { key: "loyalty_min_redemption_points", value: "5000", group: SettingGroup.LOYALTY, label: "Legacy min key — use prudent_points_min_redemption", type: SettingType.NUMBER, isPublic: false, sortOrder: 4 },
    { key: "points_per_100_naira", value: "1", group: SettingGroup.LOYALTY, label: "Unused — earn is 1 point per ₦10 via LoyaltyRule PURCHASE_PER_10", type: SettingType.NUMBER, isPublic: false, sortOrder: 5 },
    { key: "points_referral_referrer", value: "12500", group: SettingGroup.LOYALTY, label: "Unused — referral is LoyaltyRule REFERRAL_FIRST_ORDER", type: SettingType.NUMBER, isPublic: false, sortOrder: 6 },
    { key: "points_referral_new_user", value: "0", group: SettingGroup.LOYALTY, label: "Unused — referral no longer awards on signup", type: SettingType.NUMBER, isPublic: false, sortOrder: 7 },
    { key: "points_review", value: "500", group: SettingGroup.LOYALTY, label: "Unused — review is LoyaltyRule REVIEW", type: SettingType.NUMBER, isPublic: false, sortOrder: 8 },
