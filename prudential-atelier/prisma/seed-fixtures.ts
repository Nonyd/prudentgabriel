...
async function main() {
  ...
  const defaultSettings: {
    ...
    { key: "admin_notification_email", value: "admin@prudentgabriel.com", group: SettingGroup.EMAIL, label: "Admin Notification Email", type: SettingType.TEXT, isPublic: false, sortOrder: 13 },
