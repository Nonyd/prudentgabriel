...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 pb-32 pt-20">
      <h1 className="font-display text-4xl text-choc">Terms of Service</h1>
      ...
      <div className="prose prose-charcoal mt-10 max-w-none font-body text-base leading-relaxed text-charcoal">
        ...
        <h2 className="mt-8 font-display text-2xl text-choc">Orders & acceptance</h2>
        <p>
        ...
        <h2 className="mt-8 font-display text-2xl text-choc">Intellectual property</h2>
        <p>All designs, photography, and branding remain the property of Prudential Atelier unless agreed in writing.</p>
        <h2 className="mt-8 font-display text-2xl text-choc">Jurisdiction</h2>
