...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 pb-32 pt-20">
      <h1 className="font-display text-4xl text-choc">Privacy Policy</h1>
      ...
      <div className="prose prose-charcoal mt-10 max-w-none font-body text-base leading-relaxed text-charcoal">
        ...
        <h2 className="mt-8 font-display text-2xl text-choc">Data we collect</h2>
        <p>
        ...
        <h2 className="mt-8 font-display text-2xl text-choc">How we use data</h2>
        <p>We use your data to fulfil orders, process payments, communicate about your purchases, and improve our services.</p>
        <h2 className="mt-8 font-display text-2xl text-choc">Your rights</h2>
