      ...
      },
      {
        ...
        fields: [
          ...
          { key: "about_story_headline", label: "Headline", type: "text", default: "From a dream to a dynasty." },
          {
            ...
            type: "textarea",
            default:
              "Prudential Atelier was born from a single, unwavering belief — that every woman deserves to be dressed with intention. International luxury couture. Bespoke, ready-to-wear and bridal, made with love in Lagos for the world.",
          },
          {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "shop_page_title", label: "Page title", type: "text", default: "Shop" },
          {
            ...
            label: "Page subtitle",
            type: "text",
            default: "Everything the house sells — ready-to-wear, bridal, kids, and accessories.",
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        fields: [
          ...
          {
            key: "footer_shop_links",
            label: "SHOP column links",
            type: "links",
            default: JSON.stringify([
