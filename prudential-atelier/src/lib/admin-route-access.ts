...
export const ADMIN_PAGE_OWNERS: readonly {
  ...
  { path: "/admin/reports", owns: "How the house is doing", linksTo: "Nav" },
  { path: "/admin/reports/ledger", owns: "Accountant ledger", linksTo: "Nav" },
...
export const ADMIN_NAV_SECTIONS: AdminNavSectionDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/reports", label: "How we are doing", icon: "reports" },
      { href: "/admin/reports/ledger", label: "Accounts", icon: "reports" },
    ],
  },
  {
    id: "people",
