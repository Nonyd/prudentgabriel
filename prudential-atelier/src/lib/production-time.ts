...
export function fabricPolicyCopy(hours: number): string {
  return `If the fabric for your piece is unavailable, we will offer an alternative or a refund within ${hours} hours.`;
}
