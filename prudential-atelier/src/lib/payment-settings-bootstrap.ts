...
const PAYMENT_SETTING_DEFS: {
  ...
  { key: "bank_name", value: "", label: "Bank Transfer — Bank Name (NGN)", type: SettingType.TEXT, isPublic: true, sortOrder: 20 },
  { key: "bank_account_number", value: "", label: "Bank Transfer — Account Number (NGN)", type: SettingType.TEXT, isPublic: true, sortOrder: 21 },
  { key: "bank_account_name", value: "", label: "Bank Transfer — Account Name (NGN)", type: SettingType.TEXT, isPublic: true, sortOrder: 22 },
  { key: "bank_name_usd", value: "", label: "Bank Transfer — Bank Name (USD)", type: SettingType.TEXT, isPublic: true, sortOrder: 23 },
  { key: "bank_account_number_usd", value: "", label: "Bank Transfer — Account Number (USD)", type: SettingType.TEXT, isPublic: true, sortOrder: 24 },
  { key: "bank_account_name_usd", value: "", label: "Bank Transfer — Account Name (USD)", type: SettingType.TEXT, isPublic: true, sortOrder: 25 },
