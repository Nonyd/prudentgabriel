...
export const EMAIL_TEMPLATE_KEYS = {
  ...
  CONSULTATION_ENQUIRY_RECEIVED: "consultation_enquiry_received",
...
const CLIENT_TEMPLATES: EmailTemplateMeta[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      body_1: "Dear {{firstName}},\n\nYour account is for tracking this commission, viewing invoices, and the atelier portal. Design approval and receipt confirmation each arrive as their own link in a separate email — you do not need an account for those.",
  ...
  },
  {
    ...
    label: "Consultation enquiry received",
    group: "client",
    lane: "consult",
    sortOrder: 20,
    defaults: {
      subject: "We have your enquiry — {{enquiryRef}}",
      heading: "Thank you for writing to the house",
      body_1: "Dear {{firstName}},\n\nWe have your enquiry for your {{eventType}} on {{eventDate}}. The atelier reads every one and will reply by email.",
      body_2: "Nothing is booked or charged yet. If your event is soon, we may call you on the number you gave us.",
      cta_label: "",
      cta_link: "",
  ...
  },
  {
    ...
    label: "Consultation enquiry approved (booking link)",
    group: "client",
    lane: "consult",
    sortOrder: 21,
    defaults: {
      subject: "Your consultation invitation — {{enquiryRef}}",
      heading: "The house would like to meet you",
      body_1: "Dear {{firstName}},\n\nThank you for your enquiry. Please choose your consultation and propose three dates that suit you. We will confirm one against Mrs. Prudent's diary.",
      body_2: "This link is personal to you and works until {{expiresOn}}.",
  ...
  },
  {
    ...
    label: "Consultation enquiry declined",
    group: "client",
    lane: "consult",
    sortOrder: 22,
    defaults: {
      subject: "Your enquiry — {{enquiryRef}}",
      heading: "Thank you for thinking of us",
      body_1: "Dear {{firstName}},\n\nThank you for your enquiry. We are not able to take this commission, and we did not want to keep you waiting.",
      body_2: "Our ready-to-wear pieces are always open to you in the shop.",
  ...
  },
  {
    ...
    label: "Consultation reminder (day before)",
    group: "client",
    lane: "consult",
    sortOrder: 23,
    defaults: {
      subject: "Tomorrow: your consultation — {{orderRef}}",
      heading: "We look forward to seeing you",
      body_1: "Dear {{firstName}},\n\nA reminder that your consultation {{orderRef}} is tomorrow, {{date}} at {{time}} (West Africa Time).",
      body_2: "{{where}}",
      cta_label: "View booking",
      cta_link: "{{link}}",
      footer_note: "",
