...
export const LEGAL_COPY_REVISION = "ar-3";
...
Email: [hello@prudentgabriel.com](mailto:hello@prudentgabriel.com)
...
- Prudent Points credits lapse after two years (the house can change that number in settings). Lapsed points are a ledger event, not a wipe of your account.
- A signed receipt link in an email dies after seven days. The receipt file remains.
- An impersonation cookie lasts thirty minutes.
...
[hello@prudentgabriel.com](mailto:hello@prudentgabriel.com)
...
Ready-to-wear is made in 7-12 days, then shipped. Shipping time is separate and additional. A product can carry its own lead time; if it does, that figure is the one that applies to that piece. "Made in 7-12 days, then shipped" is the house default.
...
**Delivery.** The house is responsible for producing and delivering the agreed design, in good and useable condition, by the agreed date.

**Changes.** Modifications to the agreed design may be refused, or accepted at a fee, at the designer's discretion.

**Shipping.** Delivery and DHL charges are paid separately once ascertained, just before shipping, and shipping proceeds only on payment confirmation.

**Refunds.** Payments are refundable only where the house fails to meet the agreement and cannot offer a reasonable solution.
...
An atelier commission needs the deposit agreed on that quotation before production starts. The house default is 70 percent of the agreed price, unless your quotation states a different percentage. The balance must be clear before delivery.
...
Earn 1 point for every ₦10 you spend in cash (the part not paid with points). Every point is worth ₦1 towards a future piece at the current rate. Introduce a friend and receive 12,500 points once she makes her first purchase. Completing a style profile, a review, or a newsletter signup may add further points as the programme then stands. Birthday points are awarded if you have given a date of birth.

Points are valid for two years from the credit, unless the house has set a different expiry in settings. The minimum redemption is 5,000 points, unless that setting has been changed.
...
After you confirm receipt, a 30-day alteration window opens (the house can set a different number of days). Inside that window, fit and workmanship are complimentary unless the house records a reason to charge. A change you request, or damage, is chargeable. Complimentary work is still an alteration of the agreed piece, not a new commission.
...
Write first to [hello@prudentgabriel.com](mailto:hello@prudentgabriel.com) or to the Lagos address in the Privacy Policy. If we cannot settle it, the courts of Lagos State, Nigeria have jurisdiction.
...
- **Admin only.** If a Super Admin views the site as you, a cookie named \`pg_admin_impersonate\` lasts thirty minutes. A role-preview cookie named \`pg_admin_preview_role\` lasts one hour. Ordinary customers never receive these.
...
Write to [hello@prudentgabriel.com](mailto:hello@prudentgabriel.com) with the order number. The piece should be unworn, unwashed, unaltered, with tags. A change-of-mind return of a standard size is an exchange or a credit to your account. A cash refund of the payment is only given where the house failed, as the invoice says.
...
Payments are refundable only where the house fails to meet the agreement and cannot offer a reasonable solution.
...
After you confirm receipt, you have 30 days (unless the house has set a different window) to ask for a fit or workmanship alteration. That is complimentary unless the house records a reason to charge. A change you request later is a new, chargeable instruction, not a return.
...
Nothing is held in stock. A ready-to-wear piece is made in 7-12 days, then shipped. Shipping time is extra. If a product shows its own production days, those days apply to that piece.
...
Delivery and DHL charges are paid separately once ascertained, just before shipping, and shipping proceeds only on payment confirmation.
...
If you collect, we give you a collection code when the piece is ready. If it sits uncollected, we send a reminder after a number of days (seven unless the house has set another figure). Write to us if you need a different arrangement. The software reminds. It does not throw the piece away.
...
For shipping: [hello@prudentgabriel.com](mailto:hello@prudentgabriel.com)`;
