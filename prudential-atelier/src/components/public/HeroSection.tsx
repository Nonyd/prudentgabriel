    ...
    <section className="bg-choc text-cream">
      <div className="mx-auto grid max-w-site gap-10 px-6 py-16 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-10 lg:py-24">
        ...
        >
          ...
          <p className="mt-6 max-w-md font-sans text-sm font-light leading-[1.8] text-cream/85">
        ...
        <motion.div
          className="relative aspect-[4/5] overflow-hidden rounded-lg border border-lightbr/30 lg:aspect-auto lg:min-h-[520px]"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <Image
            src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=900&q=85"
