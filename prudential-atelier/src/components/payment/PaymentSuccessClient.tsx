...
export function PaymentSuccessClient() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center">
      <CheckCircle2 className="mx-auto h-16 w-16 text-[var(--olive)]" strokeWidth={1.25} />
      ...
      <Link href={target} className="mt-4 inline-block font-body text-sm text-[var(--wine)] underline">
        Continue now
      </Link>
    </div>
  );
