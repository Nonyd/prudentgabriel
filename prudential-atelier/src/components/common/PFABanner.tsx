    ...
    <section className="border-y border-mid-grey bg-light-grey py-10 md:py-12">
      <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-6 px-6 text-center md:flex-row md:px-8 md:text-left">
        ...
        <button
          ...
          className="shrink-0 rounded-full border border-ink px-8 py-3 font-body text-[11px] font-medium uppercase tracking-[0.12em] text-ink transition-colors duration-200 hover:bg-ink hover:text-[#ffffff]"
        >
          {ctaText}
        </button>
      </div>
